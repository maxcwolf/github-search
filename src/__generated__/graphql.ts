...
export type GetReposQuery = { search: { repositoryCount: number, edges?: Array<{ node?: { name: string, descriptionHTML: any, owner: { login: string } | { login: string }, stargazers: { totalCount: number }, primaryLanguage?: { name: string } | null | undefined } | {} | null | undefined } | null | undefined> | null | undefined } };
